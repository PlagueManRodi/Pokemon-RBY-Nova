...
;	ld b, d
;	ld c, e
;	ld a, [wBasePtrToStatExpValues]
;	ld h, a
;	ld a, [wBasePtrToStatExpValues+1]
;	ld l, a
	;;
	CheckEvent EVENT_PLAYING_WITHOUT_STAT_EXP
	jr z, .playingWithStatExp
	xor a
	jr .playingWithoutStatExp
.playingWithStatExp
	;;
	ld a, b ; ld a, $0 (note: stat experience disabled if $0, enabled if b)
	;;
.playingWithoutStatExp
	;;
	ld d, a
	push hl
	ld hl, wMonHeader
