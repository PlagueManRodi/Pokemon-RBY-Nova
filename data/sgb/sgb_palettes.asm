...
IF DEF(_RED)
	RGB 31,29,31, 26,20,00, 21,00,04, 14,19,29 ; PAL_LOGO1
ENDC
IF DEF(_BLUE)
	RGB 31,29,31, 30,30,17, 21,00,04, 14,19,29 ; PAL_LOGO1
ENDC
	RGB 31,29,31, 30,30,17, 18,18,24, 07,07,16 ; PAL_LOGO2
	RGB 31,29,31, 27,08,06, 06,17,08, 03,02,02 ; PAL_GRREDMON
...
ENDC
	...
	RGB 31,29,31, 30,26,15, 09,20,11, 03,02,02 ; PAL_POKEBALL
