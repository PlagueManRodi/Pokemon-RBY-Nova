...
IF DEF(_MODERN)
	db POUND, REFLECT_TYPE, NO_MOVE, NO_MOVE ; level 1 learnset
ELSE
	db POUND, CONVERSION, NO_MOVE, NO_MOVE ; level 1 learnset
ENDC
...
IF DEF(_MODERN)
	tmhm MEGA_PUNCH,   RAZOR_WIND,   SWORDS_DANCE, WHIRLWIND,    MEGA_KICK,    \
	     ...
	     SLUDGE_BOMB,  X_SCISSOR,    SHADOW_BALL,  DAZZLE_GLEAM, ACID_STREAM,  \
