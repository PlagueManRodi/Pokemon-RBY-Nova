MonsterPalettes:
	...
	db PAL_CYANMON   ; SANDSHREW
	db PAL_CYANMON   ; SANDSLASH
	...
	db PAL_GRREDMON  ; BELLOSSOM
	db PAL_REDMON    ; PARAS
	db PAL_REDMON    ; PARASECT
	db PAL_PURPLEMON ; VENONAT
	db PAL_PURPLEMON ; VENOMOTH
	db PAL_YELLOWMON ; DIGLETT
	db PAL_YELLOWMON ; DUGTRIO
	...
	db PAL_PURPLEMON ; PONYTA
	db PAL_PURPLEMON ; RAPIDASH
