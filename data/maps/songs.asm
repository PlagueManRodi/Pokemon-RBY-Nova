MapSongBanks::
	...
	db MUSIC_ROUTES4, BANK(Music_Routes4) ; VERMILION_BEACH
	...
	db MUSIC_CELADON, BANK(Music_Celadon) ; CELADON_NOVA_HOUSE
	...
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; MT_MOON_B3F
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; MT_MOON_B4F
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; MT_MOON_B5F
