PowerPlant_Object:
	...
	def_object_events
	object_event  9, 20, SPRITE_POKE_BALL, STAY, NONE, 1, ELECTRODE, 43
	object_event 32, 18, SPRITE_POKE_BALL, STAY, NONE, 2, ELECTRODE, 43
	object_event 21, 25, SPRITE_POKE_BALL, STAY, NONE, 3, ELECTRODE, 43
	object_event 25, 18, SPRITE_POKE_BALL, STAY, NONE, 4, ELECTRODE, 43
	object_event 23, 34, SPRITE_POKE_BALL, STAY, NONE, 5, ELECTRODE, 43
	object_event 26, 28, SPRITE_POKE_BALL, STAY, NONE, 6, ELECTRODE, 43
	object_event 21, 14, SPRITE_POKE_BALL, STAY, NONE, 7, ELECTRODE, 43
	object_event 37, 32, SPRITE_POKE_BALL, STAY, NONE, 8, ELECTRODE, 43
	object_event  4,  9, SPRITE_BIRD, STAY, UP, 9, ZAPDOS, 50
	object_event  7, 25, SPRITE_POKE_BALL, STAY, NONE, 10, CARBOS
IF DEF(_MODERN)
	object_event 28,  3, SPRITE_POKE_BALL, STAY, NONE, 11, TM_DAZZLE_GLEAM
ELSE
