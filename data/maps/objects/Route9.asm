Route9_Object:
	...
	object_event 16, 15, SPRITE_HIKER, STAY, LEFT, 5, OPP_HIKER, 15
	object_event 43,  3, SPRITE_HIKER, STAY, LEFT, 6, OPP_HIKER, 6
	object_event 22,  2, SPRITE_COOLTRAINER_M, STAY, DOWN, 7,  OPP_BIRD_KEEPER, 3
	object_event 45, 15, SPRITE_HIKER, STAY, RIGHT, 8, OPP_HIKER, 5
	object_event 40,  8, SPRITE_COOLTRAINER_M, STAY, RIGHT, 9, OPP_BIRD_KEEPER, 16
