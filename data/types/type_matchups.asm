TypeEffects:
	...
	db ACID_TYPE,	 STEEL,		   SUPER_EFFECTIVE
	db ACID_TYPE, 	 FAIRY,        SUPER_EFFECTIVE
	db ACID_TYPE,    GROUND,       NOT_VERY_EFFECTIVE
	db ACID_TYPE,    ICE,          NOT_VERY_EFFECTIVE
	db ACID_TYPE,    ROCK,         NOT_VERY_EFFECTIVE
	db ACID_TYPE,    ACID_TYPE,    NOT_VERY_EFFECTIVE
	db ACID_TYPE,    WATER,        NO_EFFECT
	db WATER,        ACID_TYPE,    SUPER_EFFECTIVE
	db GROUND,       ACID_TYPE,    SUPER_EFFECTIVE
	db FAIRY,        ACID_TYPE,    NOT_VERY_EFFECTIVE
	db PSYCHIC_TYPE, ACID_TYPE,    NOT_VERY_EFFECTIVE
	db GHOST,        ACID_TYPE,    NOT_VERY_EFFECTIVE
	db STEEL,        ACID_TYPE,    NO_EFFECT
	db -1 ; end
