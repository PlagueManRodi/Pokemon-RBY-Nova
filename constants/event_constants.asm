...
; Pallet Town events
	...
	const EVENT_POST_GAME_START
	const_skip
	const EVENT_HALL_OF_FAME_DEX_RATING
	const_skip 2
	const EVENT_PALLET_AFTER_GETTING_POKEBALLS
	const_skip 1
	const EVENT_PLAYING_WITH_PARTY_CAPS
	const EVENT_PLAYING_WITH_LEVEL_CAPS
	const EVENT_PLAYING_WITHOUT_STAT_EXP
	const EVENT_RECEIVED_CONV_ITEMS
	const EVENT_ON_SELECT_MENU
	const EVENT_IN_NEW_MISSABLE_OBJECTS_MAP
	const_skip 10
...
; Lavender Town events
	...
	const EVENT_BEAT_AGATHA_ULTIMA
	const EVENT_GOT_CAPTURECHARM
	const_skip 1
...
; Vermilion Beach events
	const_next $3A8
	const_skip
	const EVENT_BEAT_VERMILION_BEACH_TRAINER_0
	const EVENT_BEAT_VERMILION_BEACH_TRAINER_1
	const EVENT_BEAT_VERMILION_BEACH_TRAINER_2
	const EVENT_BEAT_VERMILION_BEACH_TRAINER_3
	const EVENT_BEAT_VERMILION_BEACH_TRAINER_4
	const EVENT_BEAT_VERMILION_BEACH_TRAINER_5
	const EVENT_BEAT_VERMILION_BEACH_TRAINER_6
	const EVENT_BEAT_VERMILION_BEACH_TRAINER_7
	const EVENT_BEAT_VERMILION_BEACH_TRAINER_8
	const EVENT_BEAT_SANDYSHOCK
...
; Viridian Forest events
	...
	const EVENT_BEAT_BUGCATCHER_SUPERBOSS
...
; Mt. Moon events
	...
	const_skip
	const EVENT_MT_MOON_B3F_BOULDER_DOWN_HOLE_1
	const EVENT_MT_MOON_B3F_BOULDER_DOWN_HOLE_2
	const EVENT_MT_MOON_B3F_BOULDER_DOWN_HOLE_3
	const EVENT_MT_MOON_B3F_BOULDER_DOWN_HOLE_4
	const EVENT_MT_MOON_B3F_BOULDER_DOWN_HOLE_5
	const EVENT_MT_MOON_B3F_BOULDER_DOWN_HOLE_6
	const EVENT_MT_MOON_B3F_BOULDER_DOWN_HOLE_7
	const EVENT_MT_MOON_B4F_BOULDER_ON_SWITCH
	const EVENT_MT_MOON_B4F_BOULDER_DOWN_HOLE_1
	const EVENT_MT_MOON_B4F_BOULDER_DOWN_HOLE_2
	const EVENT_MT_MOON_B4F_BOULDER_DOWN_HOLE_3
	const EVENT_MT_MOON_B4F_BOULDER_DOWN_HOLE_4
	const EVENT_MT_MOON_B4F_BOULDER_DOWN_HOLE_5
	const EVENT_MT_MOON_B4F_BOULDER_DOWN_HOLE_6
	const EVENT_MT_MOON_B5F_BOULDER_ON_SWITCH_1
	const EVENT_MT_MOON_B5F_BOULDER_ON_SWITCH_2
	const EVENT_MT_MOON_B5F_BOULDER_ON_SWITCH_3
	const EVENT_MT_MOON_B5F_BOULDER_ON_SWITCH_4
	const_skip
	const EVENT_BEAT_SCREAMTAIL
...
; Pokémon Mansion events
	...
	const EVENT_BEAT_GIOVANNI_SUPERBOSS
...
; Cerulean Cave events
	...
	const EVENT_BEAT_MEWTWO_1ST_TIME
...
; Victory Road 1F events
	const_next $910
	const EVENT_BECAME_CHAMPION ; added to make post-game effects
...
; Rock Tunnel events
	...
	const EVENT_BEAT_COOLTRAINER_SUPERBOSS
