...
CeladonMart4ClerkText:
	script_mart POKE_DOLL, FIRE_STONE, THUNDER_STONE, WATER_STONE, LEAF_STONE, ICE_STONE, SUN_STONE, MOON_STONE, DAWN_STONE, DUSK_STONE, SHINY_STONE, ROCK_STONE, STEEL_STONE
